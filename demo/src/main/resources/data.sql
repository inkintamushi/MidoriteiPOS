...
MERGE INTO products (id, name, category, price, image_path, sold_out) KEY(id)
VALUES (2, '酒井高徳', 'alcohol', 550, '/images/product2.jpg', FALSE);

MERGE INTO products (id, name, category, price, image_path, sold_out) KEY(id)
VALUES (3, 'ドリンクウォーター', 'alcohol', 320, '/images/product5.jpg', FALSE);
...
MERGE INTO products (id, name, category, price, image_path, sold_out) KEY(id)
VALUES (7, 'くにくにの鮓冗坩', 'yaki', 160, '/images/product4.jpg', FALSE);
